  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        ...
        <div className="mt-8 space-y-1 border-t border-slate-100 pt-6 dark:border-slate-800">
      ...
      <div className="mt-auto pt-6">
        <button
          ...
          className="flex w-full items-center justify-between rounded-lg border border-slate-200 px-3 py-2 text-xs text-slate-500 transition hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
        >
          <span>Dark mode</span>
  ...
  return (
    <>
      ...
      >
        ...
        <aside
          className={[
            'absolute inset-y-0 left-0 flex h-full w-72 max-w-[85vw] flex-col border-r border-slate-200 bg-white px-5 py-6 shadow-xl transition-transform duration-200 dark:border-slate-700 dark:bg-slate-900',
      ...
      <aside className="hidden border-r border-slate-200 bg-white px-5 py-6 dark:border-slate-700 dark:bg-slate-900 lg:flex lg:min-h-full lg:flex-col">
        <SidebarContent
          isDarkMode={isDarkMode}
          onToggleTheme={onToggleTheme}
          activeItem={activeItem}
